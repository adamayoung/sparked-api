...
final class ProfileAdapterFactory {
    ...
    static func makeCountryService(fetchCountryUseCase: some FetchCountryUseCase)
        -> some CountryService
    {
        ProfileCountryServiceAdapter(fetchCountryUseCase: fetchCountryUseCase)
    }

    static func makeGenderService(fetchGenderUseCase: some FetchGenderUseCase) -> some GenderService
    {
